	...
	<body>
		...
		<div id="show-estado" class="content scaffold-show" role="main">
			...
			<ol class="property-list estado">
				...
				<g:if test="${estadoInstance?.poblacion}">
				<li class="fieldcontain">
					<span id="poblacion-label" class="property-label"><g:message code="estado.poblacion.label" default="Poblacion" /></span>
					
						<span class="property-value" aria-labelledby="poblacion-label"><g:fieldValue bean="${estadoInstance}" field="poblacion"/></span>
