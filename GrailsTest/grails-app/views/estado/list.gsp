			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="idEstado" title="${message(code: 'estado.idEstado.label', default: 'Id Estado')}" />
						...
						<g:sortableColumn property="poblacion" title="${message(code: 'estado.poblacion.label', default: 'Poblacion')}" />
				...
				<g:each in="${estadoInstanceList}" status="i" var="estadoInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${estadoInstance.id}">${fieldValue(bean: estadoInstance, field: "idEstado")}</g:link></td>
					
						<td>${fieldValue(bean: estadoInstance, field: "nombre")}</td>
					
						<td>${fieldValue(bean: estadoInstance, field: "pais")}</td>
					
						<td>${fieldValue(bean: estadoInstance, field: "poblacion")}</td>
